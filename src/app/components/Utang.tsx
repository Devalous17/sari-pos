  ...
  return (
    <div className="flex flex-col h-full bg-gray-50">
      <div className="bg-white border-b border-gray-200 p-4 md:p-6 shadow-sm">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-[#0052CC] text-white rounded-xl shadow-md hover:shadow-lg transition-all flex items-center gap-2 font-bold hover:bg-[#003d99]"
          >
        ...
        {customers.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {customers.map(customer => (
              <div key={customer.id} className="bg-white rounded-2xl p-5 shadow-[0_8px_30px_rgba(0,82,204,0.06)] hover:shadow-[0_8px_30px_rgba(0,82,204,0.12)] border border-[rgba(0,82,204,0.1)] transition-all">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-[#F4F7FE] rounded-full flex items-center justify-center">
                      <UserCircle className="w-7 h-7 text-[#0052CC]" />
                    </div>
                    <div>
                ...
                <div className="flex gap-2">
                  {customer.totalUtang > 0 && (
                    <button
                      ...
                      className="flex-1 py-2 bg-[#36B37E] text-white rounded-xl hover:bg-green-700 transition-all text-sm font-bold"
                    >
                      Record Payment
                    </button>
                  )}
                  <button
                    ...
                    className={`${customer.totalUtang > 0 ? 'w-auto px-3' : 'flex-1'} py-2 bg-red-100 text-red-600 rounded-xl hover:bg-red-200 transition-all text-sm font-bold flex items-center justify-center gap-2`}
                  >
      ...
      {showAddCustomer && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl">
            <div className="bg-[#0052CC] p-6 rounded-t-2xl flex justify-between items-center">
            ...
            <form onSubmit={handleAddCustomer} className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  autoFocus
                  className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:border-[#0052CC] focus:outline-none"
                />
              </div>
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 py-3 bg-[#0052CC] text-white rounded-xl shadow-lg hover:shadow-xl transition-all font-bold hover:bg-[#003d99]"
                >
                  Add Customer
                </button>
              </div>
      ...
      {showPayment && selectedCustomer && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl">
            <div className="bg-[#36B37E] p-6 rounded-t-2xl flex justify-between items-center">
            ...
            <form onSubmit={handlePayment} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-bold text-[#091E42] mb-2">
                  Payment Amount
                </label>
                <input
                  type="number"
                  ...
                  required
                  autoFocus
                  className="w-full px-4 py-4 text-xl font-bold border-2 border-gray-300 rounded-xl focus:border-[#36B37E] focus:outline-none"
                />
              </div>
              ...
              {paymentAmount && parseFloat(paymentAmount) > 0 && (
                <div className="bg-green-50 border-2 border-[#36B37E] p-4 rounded-xl">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-[#36B37E]">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 py-4 bg-[#36B37E] text-white rounded-xl shadow-lg hover:shadow-xl transition-all font-bold hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Record Payment
                </button>
              </div>

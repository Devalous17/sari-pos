...
export default function App() {
  ...
  { id: '37', name: 'Kopiko Blanca (Sachet)', price: 12, stock: 47, cost: 9.50, category: 'Drinks', image: 'https://k2pharmacy.ph/cdn/shop/files/Kopiko_BlancaTwinPack58g-Resized1_grande.jpg?v=1713142796', maxStock: 50 },
  { id: '38', name: 'Nescafe Original (3-in-1)', price: 13, stock: 47, cost: 10, category: 'Drinks', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPWNPjbkEb1AMHtWxqHOA1M2kME4yqdpbMmQ&s', maxStock: 50 },
  { id: '39', name: 'C2 Green Tea (230ml)', price: 17, stock: 27, cost: 14, category: 'Drinks', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRc7GlYreYyON7LA2h_GoczPE0HMQGnCFURdw&s', maxStock: 30 },
  { id: '40', name: 'Royal Tru-Orange (Mismo)', price: 22, stock: 22, cost: 18, category: 'Drinks', image: 'https://www.magicstarsupermarket.com/cdn/shop/products/download_46_580x.jpg?v=1590302413', maxStock: 25 },
  { id: '41', name: 'Mountain Dew (290ml)', price: 20, stock: 27, cost: 16, category: 'Drinks', image: 'https://cdn.store-assets.com/s/377840/i/16427684.jpeg', maxStock: 30 },
  { id: '42', name: 'Sting Energy (Strawberry)', price: 22, stock: 25, cost: 18, category: 'Drinks', image: 'https://zbga.shopsuki.ph/cdn/shop/files/480392503342_1024x.jpg?v=1733891475', maxStock: 28 },
  { id: '43', name: 'Chuckie (180ml)', price: 28, stock: 27, cost: 24, category: 'Drinks', image: 'https://images.freshop.ncrcloud.com/1564405684702540403/48dd27e587e548bcec2d8589f52ee892_large.png', maxStock: 30 },
  { id: '44', name: 'Zesto Big 250 (Orange)', price: 12, stock: 42, cost: 9.50, category: 'Drinks', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHwwk7pD_uPlpyYKDCjtJO_k6use7-CgDRRA&s', maxStock: 45 },
  { id: '45', name: 'Red Horse (500ml Bottle)', price: 65, stock: 21, cost: 58, category: 'Drinks', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcStE2rxPubiUen8bBLah68MfUApLp2eucPh3g&s', maxStock: 24 },
  { id: '46', name: 'San Mig Light (Can)', price: 70, stock: 21, cost: 62, category: 'Drinks', image: 'https://store.iloilosupermart.com/wp-content/uploads/2020/12/878798.jpg', maxStock: 24 },
  { id: '47', name: 'Marlboro Light', price: 10, stock: 50, cost: 7.50, category: 'Other', image: 'https://www.srssulit.com/wp-content/uploads/products/9338-3.png', maxStock: 50 },
  { id: '48', name: 'Marlboro Blue', price: 10, stock: 50, cost: 7.50, category: 'Other', image: 'https://www.srssulit.com/wp-content/uploads/products/28700-3.png', maxStock: 50 },
  { id: '49', name: 'Camel', price: 10, stock: 50, cost: 7.50, category: 'Other', image: 'https://www.magicstarsupermarket.com/cdn/shop/products/C-LOCAL-22_CIGARETTE_LOCAL_WINSTON_LIGHT_HARD_PACK_1024x1024_c3c955da-68df-431b-a69f-514529530cb0_580x.jpg?v=1592192822', maxStock: 50 },
  { id: '50', name: 'Mighty', price: 10, stock: 50, cost: 7.50, category: 'Other', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSlO9z7ta8Ahg2oEe6vc74mo7F-3m29yMkXEw&s', maxStock: 50 },
  { id: '51', name: 'Winston Light', price: 10, stock: 50, cost: 7.50, category: 'Other', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR26CweOiVb52wi8g0Wcf16zgk_hZrmJCPQSA&s', maxStock: 50 },
  { id: '52', name: 'Gin 2x2', price: 150, stock: 10, cost: 120, category: 'Drinks', image: 'https://images.freshop.ncrcloud.com/1564405684702538189/ebd347d598d912f1ac7d293427734ac8_large.png', maxStock: 10 },
  { id: '53', name: 'Gin 4x4', price: 150, stock: 10, cost: 120, category: 'Drinks', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSHRpR-_MUzRADPZ96f2_B61XjVXW2YELG62A&s', maxStock: 10 },
  { id: '54', name: 'Primera', price: 150, stock: 10, cost: 120, category: 'Drinks', image: 'https://ever.ph/cdn/shop/files/100000093155-Primera-Light-Premium-Brandy-1L-230626_18ea256d-ebac-46ab-9f83-e5f0e4baa2d6.jpg?v=1770003845', maxStock: 10 },
  { id: '55', name: 'Red Horse (Bottle)', price: 150, stock: 10, cost: 120, category: 'Drinks', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQry8jAeGx6xL0YeuPgctj474_CyyI9JmuRIA&s', maxStock: 10 },
  { id: '56', name: 'Emperador Lights', price: 150, stock: 10, cost: 120, category: 'Drinks', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTCJL_dD6vPw6pdAat0mxgeTgRedGwk_qsUdw&s', maxStock: 10 },
  { id: '57', name: 'Alfonso Light', price: 150, stock: 10, cost: 120, category: 'Drinks', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyGGj6GSQD3ScSSQrNkItGzEu8yw7FNowDtw&s', maxStock: 10 },
];

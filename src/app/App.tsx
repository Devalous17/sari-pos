...
export default function App() {
  ...
  const handleSale = (
    ...
    // Deduct stock for all payment methods (cash, gcash, and utang)
      ...
      <div className="hidden md:flex flex-col h-full max-w-[1400px] mx-auto w-full">
        ...
        <div className="bg-white border-b border-gray-200 shadow-sm">
          <div className="p-6 flex items-center justify-between">
            <div>
              <h1 className="text-[#0052CC] text-2xl font-bold">Sari-Sari Store POS</h1>
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`px-6 py-3 rounded-xl flex items-center gap-2 transition-all ${
                  activeTab === 'cashier'
                    ? 'bg-[#0052CC] text-white shadow-md font-bold'
                    : 'text-[#091E42] hover:bg-[#F4F7FE] font-semibold'
                }`}
              >

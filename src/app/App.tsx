...
export default function App() {
  ...
  useEffect(() => {
    ...
    const initialProducts: Product[] = [
      ...
      { id: '4', name: 'Milo', price: 10, stock: 120, cost: 7, category: 'Drinks', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsuRCWlLEPNtlFNJ_XVDRC0ydYORASEcweDA&s' },
      { id: '5', name: 'Eggs', price: 9, stock: 80, cost: 7, category: 'Fresh Items', image: 'https://images.unsplash.com/photo-1506976785307-8732e854ad03?w=400&h=400&fit=crop' },
